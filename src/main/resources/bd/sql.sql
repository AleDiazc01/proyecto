...
(4,'Valeria', 'Mora Mena',     'vmora@gmail.com',      '3428-8456'),
(5,'Isabel', 'Loria Castro',     'iloria@gmail.com',      '7467-2486');
...
(6,1, 'Pollo al horno con papas y zanahorias', 'Un plato fácil y delicioso de pollo al horno con papas y zanahorias.', '4 pechugas de pollo sin piel,4 papas grandes, peladas y cortadas en cubos,4 zanahorias grandes, peladas y cortadas en trozos,1 cebolla grande, cortada en cubos,4 dientes de ajo, picados,2 cucharadas de aceite de oliva,1 cucharadita de romero seco,1 cucharadita de tomillo seco,Sal y pimienta al gusto', 'Precalienta el horno a 200°C., Coloca las papas, zanahorias, cebolla y ajo en una fuente para hornear grande y revuelve para combinar., Agrega el aceite de oliva, romero, tomillo, sal y pimienta al gusto y mezcla bien., Coloca las pechugas de pollo encima de las verduras y sazona con sal y pimienta al gusto., Hornea el pollo y las verduras durante unos 30-40 minutos, o hasta que el pollo esté cocido y dorado por fuera y las verduras estén suaves., Sirve el pollo y las verduras en platos individuales y disfruta.','https://p1.pxfuel.com/preview/620/704/941/roasted-chicken-thighs-potatoes-carrots-tomatoes.jpg');
...
(4,4,4,'Limpia a medida que avanzas para evitar una gran cantidad de platos y utensilios sucios.'),
(5,1,3,'Usa cuchillos afilados para evitar lesiones y hacer el trabajo más fácil.'),
(6,6,5,'Lava el arroz antes de cocinarlo para eliminar el exceso de almidón y evitar que se pegue.'),
(7,5,1,'Usa una proporción de 2 partes de agua por cada parte de arroz.'),
(8,6,3,'Una vez que el agua empiece a hervir, baja el fuego a bajo y tapa la olla para que el arroz se cocine a fuego lento.'),
(9,4,5,'No destapes la olla hasta que el arroz esté completamente cocido y el agua se haya evaporado.'),
(10,6,3,'Una vez que el arroz esté cocido, déjalo reposar tapado durante unos minutos antes de servir para que los granos se asienten y estén más suaves.');
